...
func (km *KeyMappingManager) LoadConfig() error {
	...
	// 새로운 형식 (중복키 지원): map[string][]*KeyMapping
...
func (km *KeyMappingManager) GetKeyDescription(key string) string {
	...
	descriptions := map[string]string{
		"space": "스페이스바", "enter": "엔터", "esc": "ESC", "tab": "탭",
		"backspace": "백스페이스", "delete": "Delete", "home": "Home", "end": "End",
		"pageup": "Page Up", "pagedown": "Page Down", "insert": "Insert",
		"left": "왼쪽 화살표", "right": "오른쪽 화살표", "up": "위쪽 화살표", "down": "아래쪽 화살표",
		"shift": "Shift", "ctrl": "Ctrl", "alt": "Alt", "cmd": "Cmd", "win": "Windows",
	}
	...
	if km.isComboKey(key) {
		...
		for i, part := range parts {
			descs[i] = km.GetKeyDescription(part)
		}
